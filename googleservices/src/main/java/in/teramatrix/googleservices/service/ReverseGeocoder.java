 ...
 * address, we are interacting to the Google Server (callling Api). Here we are broadcasting results in {@link in.teramatrix.googleservices.service.ReverseGeocoder.ReverseGeocodingListener}
