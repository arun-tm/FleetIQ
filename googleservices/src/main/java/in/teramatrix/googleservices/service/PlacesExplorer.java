...
/**
 * This class is structured to use Google's Places API using Builder Pattern. Google Places Api will find the places  arround the location
 * you passed in the api parameters. Although Places API has more features but this class is only constructed to explore places aaround a particular location.
