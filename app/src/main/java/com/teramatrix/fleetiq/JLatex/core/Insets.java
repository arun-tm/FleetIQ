 ...
 * four edges of a Rectangle. By convention, positive values move edges towards
...
public class Insets {
	...
	/**
	 * Two Insets instances are equal iff they belong to the same class and
	 * their fields are pairwise equal.
	 *
	 * @param o
	...
	public String toString() {
		return "Insets{" + "left=" + left + ", top=" + top + ", right=" + right
				+ ", bottom=" + bottom + '}';
	}
}
