package com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.velocimeter;
...
public class InternalVelocimeterPainterImp implements InternalVelocimeterPainter {
  ...
  private float startAngle = DimensionUtils.startAngle;
  private float finishAngle = DimensionUtils.endAngle;
