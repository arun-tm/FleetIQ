package com.teramatrix.fleetiq.velocimeter.velocimeterlibrary;
...
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.bottom.BottomVelocimeterPainter;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.bottom.BottomVelocimeterPainterImp;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.digital.Digital;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.digital.DigitalBlurImp;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.digital.DigitalImp;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.inside.InsideVelocimeterMarkerPainter;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.inside.InsideVelocimeterMarkerPainterImp;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.inside.InsideVelocimeterPainterImp;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.needle.LineBlurPainter;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.needle.NeedlePainter;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.needle.NeedlePainterImp;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.progress.BlurProgressVelocimeterPainter;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.progress.ProgressVelocimeterPainter;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.progress.ProgressVelocimeterPainterImp;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.velocimeter.InternalVelocimeterPainter;
import com.teramatrix.fleetiq.velocimeter.velocimeterlibrary.painter.velocimeter.InternalVelocimeterPainterImp;
...
public class VelocimeterView extends View {
    ...
    private void initAttributes(TypedArray attributes) {
        ...
        digitalNumberBlurColor =
                attributes.getColor(R.styleable.VelocimeterView_digital_number_blur_color,
                        digitalNumberBlurColor);
        max = attributes.getInt(R.styleable.VelocimeterView_max2, max);
    ...
    public void setValue(float value, boolean animate,int surplusValue) {
        this.value = value;
        if (value <= max && value >= min) {
            if (!animate) {
                updateValueProgress(value);
                updateValueNeedle(value,surplusValue);
            } else {
                animateProgressValue();
            }
        }
    ...
    private void updateValueNeedle(float value,int surplusValue) {
        linePainter.setValue(value);
        blurLinePainter.setValue(value);
        digitalPainter.setValue(value+surplusValue);
        digitalBlurPainter.setValue(value+surplusValue);
    }
